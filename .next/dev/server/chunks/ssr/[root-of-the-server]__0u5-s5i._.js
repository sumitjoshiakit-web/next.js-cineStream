...
async function HomePage() {
    const initialData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tmdb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPopularMovies"])(1);
...
"[project]/data/mockMovies.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockMovies$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/mockMovies.ts [app-rsc] (ecmascript)");
;
...
async function getPopularMovies(page = 1) {
    ...
    const results = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockMovies$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_MOVIES"].slice(startIndex, startIndex + PAGE_SIZE);
    return {
        page,
        results,
        total_pages: Math.ceil(__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockMovies$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_MOVIES"].length / PAGE_SIZE),
        total_results: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockMovies$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_MOVIES"].length,
        source: 'demo'
    };
}
async function getMovieById(id) {
    ...
    const found = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockMovies$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_MOVIES"].find((m)=>m.id === numericId);
    return found || null;
}
async function searchMoviesServer(query, page = 1) {
    ...
    const matched = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockMovies$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_MOVIES"].filter((m)=>m.title.toLowerCase().includes(lower) || m.overview.toLowerCase().includes(lower) || m.original_title && m.original_title.toLowerCase().includes(lower));
    const PAGE_SIZE = 12;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0u5-s5i._.js.map